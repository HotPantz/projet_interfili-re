...
int main() {
    ...
    cv::FileStorage fsClassifications("xml/classifications.xml", cv::FileStorage::READ);        // Open the classifications file
    ...
    cv::FileStorage fsTrainingImages("xml/images.xml", cv::FileStorage::READ);          // Open the training images file
    ...
    // Load test image
    cv::Mat matTestingNumbers = cv::imread("images/test5.png");            // Read in the test numbers image
